  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
          Wellcare <span className="legal-siteSign"></span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Wellcare, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Wellcare, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Wellcare is designed to simplify healthcare access. You can choose
      ...
      <div className="legal-footer">
        <p>© 2013-2023 Wellcare. All rights reserved.</p>
      </div>
    </div>
  );
}
